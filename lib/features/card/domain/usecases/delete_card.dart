...
class DeleteCard implements UseCase<String, DeleteCardParams> {
  final CardRepository _repository;

  DeleteCard(this._repository);

  @override
  Future<Either<UIError, String>> call([DeleteCardParams? params]) async {
    UseCase.assertParamsRequired(params);
    try {
      final response = await _repository.deleteCard(cardId: params!.cardId);
