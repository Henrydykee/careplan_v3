...
class RegistrationRequestModelMapper
  ...
  static RegistrationRequestModelMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = RegistrationRequestModelMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<RegistrationRequestModel, String> _f$deviceId = Field(
    'deviceId',
    _$deviceId,
    opt: true,
  );
  static String? _$deviceFcm(RegistrationRequestModel v) => v.deviceFcm;
  static const Field<RegistrationRequestModel, String> _f$deviceFcm = Field(
    'deviceFcm',
    _$deviceFcm,
    opt: true,
  );
  static String? _$ip(RegistrationRequestModel v) => v.ip;
  static const Field<RegistrationRequestModel, String> _f$ip = Field(
    'ip',
    _$ip,
    opt: true,
  );
  static String? _$osType(RegistrationRequestModel v) => v.osType;
  static const Field<RegistrationRequestModel, String> _f$osType = Field(
    'osType',
    _$osType,
    opt: true,
  );
  static String? _$osVersion(RegistrationRequestModel v) => v.osVersion;
  static const Field<RegistrationRequestModel, String> _f$osVersion = Field(
    'osVersion',
    _$osVersion,
    opt: true,
  );
  static String? _$brand(RegistrationRequestModel v) => v.brand;
  static const Field<RegistrationRequestModel, String> _f$brand = Field(
    'brand',
    _$brand,
    opt: true,
  );
  static String? _$model(RegistrationRequestModel v) => v.model;
  static const Field<RegistrationRequestModel, String> _f$model = Field(
    'model',
    _$model,
    opt: true,
  );
...
mixin RegistrationRequestModelMappable {
  ...
  RegistrationRequestModelCopyWith<
    RegistrationRequestModel,
    RegistrationRequestModel,
    RegistrationRequestModel
  >
  get copyWith =>
      _RegistrationRequestModelCopyWithImpl<
        RegistrationRequestModel,
        RegistrationRequestModel
      >(this as RegistrationRequestModel, $identity, $identity);
  @override
  String toString() {
    return RegistrationRequestModelMapper.ensureInitialized().stringifyValue(
      this as RegistrationRequestModel,
    );
  }

  @override
  bool operator ==(Object other) {
    return RegistrationRequestModelMapper.ensureInitialized().equalsValue(
      this as RegistrationRequestModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return RegistrationRequestModelMapper.ensureInitialized().hashValue(
      this as RegistrationRequestModel,
    );
  }
}
...
extension RegistrationRequestModelValueCopy<$R, $Out>
  ...
  get $asRegistrationRequestModel => $base.as(
    (v, t, t2) => _RegistrationRequestModelCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
