...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  void _onAuthStateChanged() {
    ...
    if (_authProvider.hasError) {
      ...
      showErrorDialog(context, "Registration Failed", _authProvider.errorMessage);
    ...
    if (_authProvider.isReady) {
      _hasHandledState = true;
      router.push(PhoneNumberConfrimationScreen(email: _emailAddressController.text.trim()));
    }
  }
                          ...
                          children: [
                            ...
                            CustomTextField(
                              ...
                              suffix: GestureDetector(
                                ...
                                child: Text(
                                  _showHideController.text,
                                  style: TextStyle(color: CarePlanColor.grey),
                                ),
                              ),
                            ),
                            CustomTextField(
